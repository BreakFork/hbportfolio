...
const Header = ({...props}) => {
    ...
    const HandleLinksBehavior = (link) => {
    ...
    const MobileNavbar = () => {
        return (
            <nav className="navbar-toggle--links-container dflex-cc">
                <a onClick={HandleLinksBehavior} href="#competences" data-anchor="accueil" className="navbar-toggle--link active" aria-label="link to introducting section">
                    COMPETENCES
                </a>
                <a onClick={HandleLinksBehavior} href="#projets" data-anchor="projets" className="navbar-toggle--link" aria-label="link to projects section">
                    PROJETS
                </a>
                <a onClick={HandleLinksBehavior} href="#contact" data-anchor="contact" className="navbar-toggle--link" aria-label="link to contact section">
                    CONTACT
                </a>
            </nav>
        )
        ...
        <header className='header__layout dflex-cc'>
            <div className="header__main-container">
                ...
                <nav className="navbar dflex-rc" role={"navigation".toString()} aria-label="Main navigation">
                    <a onClick={HandleLinksBehavior} href="#competences" aria-label='Naviguer vers la section compétences' data-anchor="accueil" className="navbar__link active">
                        COMPETENCES
                    </a>
                    <a onClick={HandleLinksBehavior} href="#projets" aria-label='Naviguer vers la section projets' data-anchor="projets" className="navbar__link">
                        PROJETS
                    </a>
                    <a onClick={HandleLinksBehavior} href="#contact" aria-label='Naviguer vers la section contact' data-anchor="contact" className="navbar__link">
                        CONTACT
                    </a>
                </nav>
            </div>
